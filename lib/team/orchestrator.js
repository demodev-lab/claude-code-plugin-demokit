...
function buildTeamComposition(phase, level) {
  ...
  return {
    ...
    maxParallel,
    delegateMode: team.delegateMode === true,
    delegateAgent: team.delegateAgent || null,
  };
}
...
function buildTeamContextForPhase(phase, feature, options = {}) {
  ...
  return {
    ...
    delegateMode: composition.delegateMode === true,
    delegateAgent: composition.delegateAgent || null,
