...
/**
 * Worktree에서 verify 명령어 실행
 */
function verifyWorktree(worktreePath, verifyCommand) {
  if (!verifyCommand) return { passed: true, skipped: true, output: '' };
  validatePath(worktreePath);
  try {
