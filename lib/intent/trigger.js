...
const INTENT_PATTERNS = [
  ...
  {
    id: 'dto',
    patterns: [/^\/\s*dto\b/i, /dto/i, /request|response\s*(객체|클래스)/i, /create\s+(a\s+)?dto/i, /add\s+(a\s+)?(request|response)\s+(class|record)/i],
    command: '/dto',
    description: 'DTO 생성',
    agent: 'api-expert',
  },
  ...
  {
    id: 'pdca',
    patterns: [/^\/\s*pdca\b/i, /pdca/i, /\b(plan|design|do|analyz|iterate|report|status|next|archive|cleanup)\s+/i],
    command: '/pdca',
